...
static yyconst flex_int16_t yy_base[26] =
    {   0,
        0,    0,   42,   10,   37,    0,    0,    0,   20,    0,
        0,   30,   57,   34,    0,    0,   32,   40,   24,   57,
       23,   57,   49,   28,   52
    } ;

static yyconst flex_int16_t yy_def[26] =
    {   0,
       22,    1,   22,   22,   22,   23,   23,   24,   22,   25,
        4,    4,   22,   22,   23,   24,    9,    9,   25,   22,
       25,    0,   22,   22,   22
    } ;
...
static yyconst flex_int16_t yy_nxt[68] =
    {   0,
       ...
       11,   12,   13,   12,   12,   12,   11,   11,   12,   11,
       17,   18,   13,   18,   18,   18,   17,   17,   18,   17,
       12,   16,   21,   21,   20,   14,   12,   12,   14,   12,
       18,   22,   20,   22,   22,   22,   18,   18,   22,   18,
       15,   15,   19,   22,   19,   19,    3,   22,   22,   22,
...
static yyconst flex_int16_t yy_chk[68] =
    {   0,
        ...
        4,    4,    4,    4,    4,    4,    4,    4,    4,    4,
        9,    9,    9,    9,    9,    9,    9,    9,    9,    9,
       12,   24,   21,   19,   17,   14,   12,   12,    5,   12,
       18,    3,   18,    0,    0,    0,   18,   18,    0,   18,
       23,   23,   25,    0,   25,   25,   22,   22,   22,   22,
       22,   22,   22,   22,   22,   22,   22
    } ;
...
YY_DO_BEFORE_ACTION; /* set up yytext again */
YY_RULE_SETUP
<<<<<<< HEAD:src/haml_lexer/haml_lexer.c
...
>>>>>>> 6746e02591402105b81d94d11388a3fb7de6d506:src/sass/sass_lexer.c
	YY_BREAK
case 6:
*yy_cp = (yy_hold_char); /* undo effects of setting up yytext */
(yy_c_buf_p) = yy_cp -= 1;
